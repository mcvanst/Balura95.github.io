...
let spotifySDKReady = new Promise((resolve) => {
    window.onSpotifyWebPlaybackSDKReady = () => {
      ...
      // Fehler-Listener (optional, hier nur protokollieren)
  ...
  // Prüfe, ob ein Access Token vorhanden ist, ansonsten zur Login-Seite umleiten
  ...
  // Hilfsfunktion: Extrahiere Playlist-ID aus der URL
  ...
  // Lade Tracks der Playlist via Spotify API
  ...
  async function playRandomTrack() {
    ...
    await spotifySDKReady; // Warten, bis der SDK bereit ist
